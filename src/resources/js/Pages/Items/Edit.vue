                                ...
                                <div class="container px-5 py-24 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <textarea id="memo" v-model="form.memo" name="memo" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="number" v-model="form.price" id="price" name="name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="radio" v-model="form.is_selling" value="1" id="is_selling" name="is_selling">
                                            <label class="ml-2 mr-4">販売中</label>  
                                            <input type="radio" v-model="form.is_selling" value="0" id="is_selling" name="is_selling">
