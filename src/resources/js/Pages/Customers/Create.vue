                        ...
                        <section class="text-gray-600 body-font relative">
                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="errors.name" class="text-red-500" >{{ errors.kana }}</div>
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="errors.name" class="text-red-500" >{{ errors.tel }}</div>
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="errors.name" class="text-red-500" >{{ errors.email }}</div>
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="errors.name" class="text-red-500" >{{ errors.postcode }}</div>
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="errors.name" class="text-red-500" >{{ errors.address }}</div>
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="errors.name" class="text-red-500" >{{ errors.birthday }}</div>
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="errors.name" class="text-red-500" >{{ errors.gender }}</div>
                                </div>
                                </div>
                                ...
                                <div class="relative">
                                    ...
                                    <div v-if="errors.name" class="text-red-500" >{{ errors.memo }}</div>
                                </div>
                                </div>
