                              ...
                              <table class="table-auto w-full text-left whitespace-no-wrap">
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <input disabled type="radio" id="customer" v-model="form.status" name="customer" :value="1" >未キャンセル
                                    <input disabled type="radio" id="customer" v-model="form.status" name="customer" :value="0" >キャンセル済
